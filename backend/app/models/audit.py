...
from app.models.enums import AuditRunStatus, NotificationType, SeverityLevel, db_enum
...
class AuditRun(ORMBaseModel):
    ...
    status: Mapped[AuditRunStatus] = mapped_column(
        db_enum(AuditRunStatus, "audit_run_status"),
...
class AuditResult(ORMBaseModel):
    ...
    severity: Mapped[SeverityLevel] = mapped_column(
        db_enum(SeverityLevel, "severity_level"), nullable=False
    )
